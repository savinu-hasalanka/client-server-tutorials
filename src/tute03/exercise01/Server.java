    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(portNumber)) {
            ...
            while (true) {
                ...
                The PrintWriter class constructor takes two parameters: the client socket's output stream and a boolean indicating whether to automatically flush the output stream after every write operation.** */
