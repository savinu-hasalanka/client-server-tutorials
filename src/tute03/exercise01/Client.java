...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try (Socket socket = new Socket(serverAddress, serverPort)) {
            ...
            The PrintWriter class constructor takes two parameters: the socket output stream and a boolean indicating whether to automatically flush the output stream after every write operation.** */
